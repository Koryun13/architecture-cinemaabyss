...
| `monolith.image.repository`    | Monolith image repository                       | `ghcr.io/koryun13/architecture-cinemaabyss/monolith` |
...
| `proxyService.image.repository`| Proxy service image repository                  | `ghcr.io/koryun13/architecture-cinemaabyss/proxy-service` |
...
| `moviesService.image.repository`| Movies service image repository                | `ghcr.io/koryun13/architecture-cinemaabyss/movies-service` |
...
| `eventsService.image.repository`| Events service image repository                | `ghcr.io/koryun13/architecture-cinemaabyss/events-service` |
...
| `config.kafkaBrokers`         | Kafka bootstrap servers (events service)        | `kafka:9092`    |
